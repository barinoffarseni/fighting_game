...
export class SpriteAnimated extends SpriteStatic {
...
export class Fighter extends SpriteAnimated {
...
export class WinIndicator extends Indicator {
  constructor () {
    super({
      position: {
        x: canvas.width / 2,
...
export class Timer extends Indicator {
  constructor () {
    super({
      position: {
        x: canvas.width / 2,
...
export class HealthBar extends Indicator {
